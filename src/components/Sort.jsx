...
export default function Sort() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-12 z-10 w-64 py-2 px-4 divide-y divide-gray-300 rounded border border-gray-300 bg-white shadow-sm dark:divide-gray-600 dark:border-gray-600 dark:bg-gray-900">
