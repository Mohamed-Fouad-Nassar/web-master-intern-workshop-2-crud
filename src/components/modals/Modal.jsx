...
export default function Modal() {
  ...
  return (
    ...
    >
      {/* modal */}
      <div className="bg-primary-bg dark:bg-primary-bg-dark px-10 pb-8 pt-0 min-w-1/2 min-h-1/2 max-w-6xl w-[90%] max-h-[90%] overflow-auto absolute rounded-md flex flex-col">
        {/* modal header */}
